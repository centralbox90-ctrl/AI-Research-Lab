...
открывает страницу созданного результата. Страница начинается с
компактного научного резюме: гипотезы, результата validation, силы
evidence, решения по гипотезе, confidence, вывода и ключевых метрик.
Технический execution lifecycle остаётся отдельным от научной оценки.
